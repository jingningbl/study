...
<div class="panel panel-primary">
  ...
  <div class="panel-body">
    <form action="updateSong" class="form-horizontal">
      ...
      <input value="${applicationScope.song.id}" name="id" type="hidden">
      ...
      <div class="form-group form-group-sm">
        ...
        <div class="col-sm-5 col-md-6">
          <input type="text" class="form-control" name="name" id="music_name" value="${applicationScope.song.name}">
        </div>
      </div>
      <div class="form-group form-group-sm">
        <label class="col-sm-2 col-md-1 control-label">歌手名称</label>
        <div class="col-sm-5 col-md-6">
          <input type="text" class="form-control" name="singer" id="artist" value="${applicationScope.song.singer}">
        </div>
      </div>
      <div class="form-group form-group-sm">
        <label class="col-sm-2 col-md-1 control-label">专辑名称</label>
        <div class="col-sm-5 col-md-6">
          <input type="text" class="form-control" id="ablum" name="album" value="${applicationScope.song.album}">
        </div>
      </div>
      ...
      <div class="form-group form-group-sm">
        ...
        <div class="col-sm-5 col-md-6 music_style">
          <input type="text" class="form-control" id="style" name="style" value="${applicationScope.song.style}"/>
        </div>
      </div>
      ...
      <div class="form-group form-group-sm">
        ...
        <div class="col-sm-5 col-md-6 music_style">
          <input type="text" class="form-control" id="size" name="size" value="${applicationScope.song.size}"/>
        </div>
      </div>
      ...
      <div class="form-group form-group-sm">
        ...
        <div class="col-sm-5 col-md-6 music_style">
          <input type="text" class="form-control" id="address" name="location" value="${applicationScope.song.location}"/>
        </div>
      </div>
      ...
      <div class="form-group form-group-sm">
        ...
        <div class="col-sm-5 col-md-6 music_style">
          <input type="text" class="form-control" id="mytime" name="uploadTime"  value="${applicationScope.song.uploadTime}"/>
        </div>
      </div>
