		...
		<div class="navbar navbar-inverse">
			<div class="container-fluid">
			    ...
			    <ul class="nav navbar-nav navbar-right">
			    	<li class="dropdown">
			    		<a href="" class="dropdown-toggle" data-toggle="dropdown" >${applicationScope.user.username}&nbsp;<span class="caret"></span></a>
		...
		<div class="container-fluid">
			...
			<div class="col-md-2 col-sm-2 col-xs-5" id="menu">
				<div class="list-group">
				  ...
				  <a href="find2" class="list-group-item" target="page"><span class="glyphicon glyphicon-list"></span>&nbsp;音乐列表</a>
				  <a onclick="f1(this)" href="#" class="list-group-item"><span class="glyphicon glyphicon-user"></span>&nbsp;用户管理</a>
				  <a href="repassword.jsp" class="list-group-item" target="page"><span class="glyphicon glyphicon-pencil"></span>&nbsp;修改密码</a>
				  <a href="#" class="list-group-item"><span class="glyphicon glyphicon-log-out"></span>&nbsp;系统退出</a>
			...
			<!-- 版权区 -->
			<c:if test="${requestScope.user.pwd==123456}">
